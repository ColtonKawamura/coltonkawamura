...
&= \frac{ \sigma z}{2\epsilon_{0}}\left[{\frac{1}{z}}-{\frac{1}{\sqrt{R^{2}+z^{2}}}}\right]\hat{z}. \tag{3}
\end{align*}$$ 
...
This makes sense, we if go out far enough the electric field will eventually drop off to zero. But
