...
To find the potential, we first need to find the electric field of the configuration at the point $$z$$.

In this configuration, we should immediately start ruling out the horizontal components of the total force by symmetry. Are target now is to determine the vertical portion of the electric field in the $$z$$-direction. 
