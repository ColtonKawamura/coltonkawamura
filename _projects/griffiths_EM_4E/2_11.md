...
$$
\begin{align*}
\oint_{S}\mathbf{E_\text{outside}}\cdot d{\mathbf{a}}&={\frac{1}{\epsilon_{0}}}Q_{\mathrm{{enc}}} \\
...
$$
\begin{align*}
\oint_{S}\mathbf{E_\text{inside}}\cdot d{\mathbf{a}}&={\frac{1}{\epsilon_{0}}}Q_{\mathrm{{enc}}} \\
