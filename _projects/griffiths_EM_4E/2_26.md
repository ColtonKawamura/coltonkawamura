...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/griffiths_EM_4E/2-26-1.jpeg" title="Problem 2.4" class="img-fluid rounded z-depth-1" %}
    </div>
</div>

We can see we can take rings of charge with surface area $$da=2\pi r'\sigma$$ and integrate over the surface of the cone to find the potential. We also recognized that we can express $$r'=r/\sqrt{2}$$ using some geometry.

Let's use,

$$
\begin{align*}
V&=\frac{1}{4\pi\epsilon_{0}}\int\frac{\sigma({\bf r})}{r}\,d a \\
\end{align*}
$$
