...
Let's start with creating an expression for the electric field caused by each $$dq$$. Because the is a spherical shell with $$q$$ smeared out evenly across the surface, we can the infitesimal charge as $$dq=\sigma r^2\sin\theta dr d\sin d \theta$$.
