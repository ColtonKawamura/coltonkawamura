...
- Part B: Find an expression for the change $$\lambda_f-\lambda$$ in the photon wavelength for the special case $$\theta=\pi/2$$.
...
$$\begin{align*}
\left( E_f^e \right) = \left(p_f^e c\right)^2+\left( mc^2\right)^2. \tag{3}
\end{align*}$$
...
$$\begin{align*}
p_i^pc+mc^2&=p_f^pc+\sqrt{ \left(p_f^e c\right)^2+\left( mc^2\right)^2}
\end{align*}$$
