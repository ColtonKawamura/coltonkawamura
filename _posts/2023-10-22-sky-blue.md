...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/light_spectrum.jpeg" title="Light Spectrum" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/induced_dipole.jpeg" title="Induced Dipole" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/polarized_wave.jpeg" title="Polarized Light" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
...
After averaging the Poynting vector over a complete cycle of oscillation $$
