...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/quantum-temperature-1.gif" title="Quantum Temperature" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/quantum-temperature-2.gif" title="Quantum Temperature" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
